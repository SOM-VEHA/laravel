                        ...
                        <div class="card-body">
                            ...
                            <table class="table  table-hover align-middle">
                                ...
                                @foreach ($slides as $slide)
                                    <tr>
                                        <td class="text-start">{{ $slide->id }}</td>
                                        ...
                                        <td class="text-start" style="white-space: nowrap;">
                                            <a
                                                href="{{ route('slides.show', $slide->id) }}"
                                            ...
                                            <button
                                                ...
                                                data-bs-target="#slideDelete{{ $slide->id }}">
                                                Delete
                                            </button>
...
{{--                                <div>Showing 1 to 2 of 20 movies</div>--}}
{{--                                <div>--}}
...
{{--                            </div>--}}
                                <div class="d-flex justify-content-between bg-white p-3">
                                    ...
                                    <div class="d-flex gap-1">
                                        ...
                                        {{-- Page Numbers --}}
                                        @for ($page = 1; $page <= $slides->lastPage(); $page++)

                                            @if ($page == $slides->currentPage())

                                                <a href="{{ $slides->url($page) }}"
                                                   class="btn btn-primary">
                                                    {{ $page }}
                                                </a>
